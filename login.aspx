    ...
    <div id="reg">
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            <asp:View ID="View1" runat="server">
                <asp:Label ID="Label1" runat="server" Text="Username用户名" Width="150px"></asp:Label>
                <asp:TextBox ID="TextBox1" runat="server" Width="200px"></asp:TextBox>
                <br />
                <asp:Label ID="Label2" runat="server" Text="Password密码" Width="150px"></asp:Label>
                <asp:TextBox ID="TextBox2" runat="server" Width="200px"></asp:TextBox>
                <br />
                <asp:Label ID="Label3" runat="server" Text="Email邮箱" Width="150px"></asp:Label>
            ...
            <asp:View ID="View2" runat="server">
                <asp:Label ID="Label4" runat="server" Text="Username用户名" Width="150px"></asp:Label>
                <asp:TextBox ID="TextBox4" runat="server" Width="200px"></asp:TextBox>
                <br />
                <asp:Label ID="Label5" runat="server" Text="Password密码" Width="150px"></asp:Label>
